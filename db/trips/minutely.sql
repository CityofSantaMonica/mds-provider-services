...
DROP VIEW IF EXISTS public.csm_trips_minutely CASCADE;

CREATE VIEW public.csm_trips_minutely AS

SELECT * FROM csm_trip_totals_by('minute');
--     provider_name,
--     vehicle_type,
--     date_trunc('minute', csm_local_timestamp(event_time)) AS end_minute_local,
...
--     csm_trips
-- GROUP BY
--     provider_name, vehicle_type, end_minute_local
-- ORDER BY
--     provider_name, vehicle_type, end_minute_local DESC
