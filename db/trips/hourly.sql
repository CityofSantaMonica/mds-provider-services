...
DROP VIEW IF EXISTS public.csm_trips_hourly CASCADE;

CREATE VIEW public.csm_trips_hourly AS

SELECT * FROM csm_trip_totals_by('hour');
--     provider_name,
--     vehicle_type,
...
--     csm_trips
-- GROUP BY
--     provider_name, vehicle_type, end_hour_local
-- ORDER BY
--     provider_name, vehicle_type, end_hour_local DESC
