...
DROP VIEW IF EXISTS public.csm_trips_daily CASCADE;

CREATE VIEW public.csm_trips_daily AS

SELECT * FROM csm_trip_totals_by('day');
--     provider_name,
--     vehicle_type,
--     date_trunc('day', csm_local_timestamp(event_time)) AS end_day_local,
...
--     csm_trips
-- GROUP BY
--     provider_name, vehicle_type, end_day_local
-- ORDER BY
--     provider_name, vehicle_type, end_day_local DESC
