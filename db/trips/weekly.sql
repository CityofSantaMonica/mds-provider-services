...
DROP VIEW IF EXISTS public.csm_trips_weekly CASCADE;

CREATE VIEW public.csm_trips_weekly AS

SELECT * FROM csm_trip_totals_by('week');
--     provider_name,
--     vehicle_type,
...
--     csm_trips
-- GROUP BY
--     provider_name, vehicle_type, end_week_local
-- ORDER BY
--     provider_name, vehicle_type, end_week_local DESC
